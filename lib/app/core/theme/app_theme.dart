...
class AppTheme {
  ...
  static List<BoxShadow> get shadowSmall => [
    BoxShadow(color: cardShadow, offset: Offset(0, 4.h), blurRadius: 10.r),
  ];

  static List<BoxShadow> get shadowMedium => [
    BoxShadow(color: cardShadow, offset: Offset(0, 8.h), blurRadius: 20.r),
  ];

  static List<BoxShadow> get shadowLarge => [
    BoxShadow(color: cardShadow, offset: Offset(0, 12.h), blurRadius: 30.r),
  ];

  static List<BoxShadow> get darkShadowSmall => [
    BoxShadow(color: darkCardShadow, offset: Offset(0, 4.h), blurRadius: 10.r),
  ];

  static List<BoxShadow> get darkShadowMedium => [
    BoxShadow(color: darkCardShadow, offset: Offset(0, 8.h), blurRadius: 20.r),
  ];

  static List<BoxShadow> get darkShadowLarge => [
    BoxShadow(color: darkCardShadow, offset: Offset(0, 12.h), blurRadius: 30.r),
  ];
